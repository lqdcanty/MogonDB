<template>
    <div>
      ...
      <nav-bread>
        <span slot="bread">Adress</span>
        <span slot="B">Adress</span>
      </nav-bread>
        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              ...
              <div class="shipping-addr-more" v-if="attrLength>3">
            ...
            <div class="next-btn-wrap">
              <router-link class="btn btn--m btn--red" v-bind:to="{path:'orderConfirm',params:{'addressId':selectedAddrId}}">Next</router-link>
            </div>
          </div>
        </div>
      </div>
      ...
      methods:{
          init(){
            axios.get("/users/addressList").then((response)=>{
              ...
              this.attrLength=this.addressList.length;
